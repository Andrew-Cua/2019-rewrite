 ...
 */
public class CargoShipState implements IArmState
{

    private Arm m_arm;
    public CargoShipState(Arm arm)
    {
        m_arm = arm;
    }
    @Override
    ...
    {
        m_arm.set(ArmSetpoints.kCargoShip.getCargo());
    }

    @Override
    public void moveArmToHatchAngle() 
    {
        m_arm.set(ArmSetpoints.kCargoShip.getHatch());
    }
