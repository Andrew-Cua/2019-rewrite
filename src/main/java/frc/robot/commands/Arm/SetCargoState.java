 ...
 * Add your docs here.
 */
public class SetCargoState extends InstantCommand {
  /**
   * Add your docs here.
   */
  ArmSetpoints m_setpoint;
  public SetCargoState(ArmSetpoints setpoint) {
    super();
  ...
  protected void initialize() {
    Robot.m_arm.setTarget(frc.robot.subsystems.Arm.TargetPos.kCargo);
    Robot.m_arm.setState(m_setpoint);
    Robot.m_wrist.setTarget(frc.robot.subsystems.Wrist.TargetPos.kCargo);
